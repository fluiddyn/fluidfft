...
program benchmark_proj
  ...
  do i = 1, N
     call cpu_time(start)
     call proj(vx_fft, vy_fft, vz_fft, Kx, Ky, Kz, inv_K_square_nozero, N0, N1, N2)
...
subroutine proj(vx_fft, vy_fft, vz_fft, Kx, Ky, Kz, inv_K_square_nozero, N0, N1, N2)

  implicit none

  ! Input/Output
  integer, intent(in) :: N0, N1, N2
  double precision, intent(inout) :: vx_fft(2, N2, N1, N0), vy_fft(2, N2, N1, N0), vz_fft(2, N2, N1, N0)
